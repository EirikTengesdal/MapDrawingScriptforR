...
This script was made to generate maps intended for the papers *Argument placement in Norwegian* ([Lundquist & Tengesdal 2022](https://journals.uio.no/NALS/article/view/10099)) and *Argument placement in Danish* ([Larsson & Tengesdal 2022](https://journals.uio.no/NALS/article/view/10102)). The maps shown below can be reproduced using the archived script and associated files.
...
Tengesdal, Eirik. 2022. Map Drawing Script for R. *NALS – Norway & Denmark (Version 2.1.1)* [Software]. https://doi.org/10.5281/zenodo.7541937
...
@software{Tengesdal_2022_MapDrawingScriptforR,
  ...
  publisher    = {Zenodo},
  version      = {2.1.1},
  doi          = {https://doi.org/10.5281/zenodo.7541937}
}
```
